...
let cubes = [cube, cube1, cube2, cube3];
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        cubes.forEach(c => {
            ...
            for (var t = 0; t < c.faces.length; t++) {
                ...
                let dist = Math.sqrt(Math.pow(camera.position.x - meanX, 2) +
